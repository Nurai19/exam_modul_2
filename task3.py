...
def course_students(students):
    for i in students:
        if i['course'] == 'python':
            python['python'].append(i['name'])
        elif i['course'] == 'java':
            java['java'].append(i['name'])
        elif i['course'] == 'javascript':
            javascript['javascript'].append(i['name'])
...
def new_names(students):
    for student in students:
        names_ages.update({student['name']: student['age']})
    return names_ages
